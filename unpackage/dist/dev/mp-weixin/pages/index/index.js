...
var helloComp = function helloComp() {return __webpack_require__.e(/*! import() | components/helloComp */ "components/helloComp").then(__webpack_require__.bind(null, /*! ../../components/helloComp.vue */ 32));};var trailerStars = function trailerStars() {return __webpack_require__.e(/*! import() | components/trailerStars */ "components/trailerStars").then(__webpack_require__.bind(null, /*! ../../components/trailerStars.vue */ 39));};var _default = { data: function data() {return { carouselList: [], hotList: [] };}, onLoad: function onLoad() {var _this = this; // var me = this;
    ...
    uni.request({ url: this.serverUrl + '/index/movie/hot?type=superhero&qq=lee98086139', //仅为示例，并非真实接口地址。
      method: "POST", success: function success(res) {_this.hotList = res.data.data;console.log(_this.hotList);} });}, methods: {},
